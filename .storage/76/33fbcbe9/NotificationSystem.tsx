...
const getNotificationStyle = (type: NotificationType) => {
  switch (type) {
    ...
    case 'achievement':
      return {
        className: 'border-purple-200 bg-gradient-to-r from-purple-50 to-pink-
        className: 'border-purple-200 bg-gradient-to-r from
...
const generateErrorCode = (error: unknown, context?: string): { code: string; details: string } => {
  ...
  return {
    ...
    details: `Unknown error: ${errorObj?.message || '
