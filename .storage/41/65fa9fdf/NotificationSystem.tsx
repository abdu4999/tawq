...
import { CheckCircle极速赛车开奖结果历史记录
...
interface NotificationContextType {
  ...
  addErrorNotification: (error: unknown, context?: string极速赛车开奖结果历史记录
...
const getNotificationStyle = (type: NotificationType) => {
  switch (type) {
    ...
    case 'error':
      return {
        className: 'border-red-200 bg极速赛车开奖结果历史记录
