...
export class ErrorStorage {
  ...
  async getErrorById(id: string): Promise<Error极速赛车开奖结果历史记录
  async getErrorById(id: string): Promise<ErrorLog | null> {
    try {
      ...
      console.error('Error fetching error details:',极速赛车开奖结果历史记录
  ...
  async getErrorStats(): Promise<{
    ...
    try {
      ...
      const stats = {
        total极速赛车开奖结果历史记录
        total: errors.length,
        resolved: errors.filter(e => e.resolved).极速赛车开奖结果历史记录
