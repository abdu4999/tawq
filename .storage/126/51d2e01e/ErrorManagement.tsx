...
export default function ErrorManagement() {
  ...
  const exportErrors = () => {
    ...
    const blob = new Blob([csvContent], { type: 'text/csv极速赛车开奖结果极速赛车开奖结果历史记录
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex" dir="rtl">
      ...
      <div className="flex-1 mr-80 p-极速赛车开奖结果历史记录
      <div className="flex-1 mr-80 p-6 space-y-6">
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 via-purple-极速赛车开奖结果历史记录
          <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
            إدارة الأخطاء
          </h1>
          <p className="text-xl text-gray-600">تتبع وإدارة أخطاء النظام</极速赛车开奖结果历史记录
          ...
          <Card className="bg-gradient-to-br from-green-500 to-green-600 text-white border-0">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <极速赛车开奖结果历史记录
                  <p className="text-green-100极速赛车开奖结果历史记录
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex gap-4">
              ...
              <Button variant="outline" onClick={exportErrors极速赛车开奖结果历史记录
        ...
        <Card>
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="space-y-4极速赛车开奖结果历史记录
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-sm font-medium text-gray-极速赛车开奖结果历史记录
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p>{formatDate(selectedError.timestamp)}</极速赛车开奖结果历史记录
                  ...
                  <div>
                    ...
                    <Badge
                      ...
                      className={selected极速赛车开奖结果历史记录
