...
import { Card, CardContent极速赛车开奖结果历史记录
import React, { useState, useEffect } from 'react';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { Badge } from '@/极速赛车开奖结果历史记录
...
export default function ErrorManagement() {
  ...
  const [selectedError, setSelected极速赛车开奖结果历史记录
  const [selectedError, setSelectedError] = useState<Error极速赛车开奖结果历史记录
  ...
  const exportErrors = () => {
    const csvContent = [
      ...
      ...errors.map(error => [
        ...
        error.resolved_at ? new Date(error.resolved_at).极速赛车开奖结果历史记录
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex" dir="rtl">
      ...
      <div className="flex-1 mr-80 p-6 space-y-6">
        <div className="text-center space极速赛车开奖结果历史记录
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="bg-gradient-to-br from-blue-500 to-blue-极速赛车开奖结果历史记录
          <Card className="bg-gradient-to极速赛车开奖结果历史记录
          <Card className="bg-gradient-to-br from-blue-500 to-blue-600 text-white border-0">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-100 text-sm">إجمالي الأخطاء</p>
                  <p className="text-3xl font-bold">{stats.total}</极速赛车开奖结果历史记录
                  <p className="text-3极速赛车开极速赛车开奖结果历史记录
          ...
          <CardContent>
            {loading ? (
              <div className="text-center py-8">
                <div className="animate-sp极速赛车开奖结果历史记录
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-700">رمز الخطأ极速赛车开奖结果历史记录
                ...
                <div className极速赛车开奖结果历史记录
                <div className="grid grid-c极速赛车开奖结果历史记录
                <div className="grid grid-cols-2 gap-4">
                  <div>
                  ...
                  <div>
                    ...
                    <Badge
                      ...
                      className={selectedError.resolved ? 'bg-green-极速赛车开奖结果历史记录
