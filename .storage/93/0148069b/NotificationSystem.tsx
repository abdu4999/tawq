...
import { CheckCircle, XCircle, AlertTriangle, Info, Trophy, Credit极速赛车开奖结果历史记录
  ...
  switch (type) {
    ...
    case 'celebration':
      return {
        ...
        iconColor: 'text-pink-极速赛车开奖结果历史记录
...
export const NotificationProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  const addNotification = useCallback((notification: Notification) => {
    ...
    const toastOptions = {
      duration: persistent ? Infinity极速赛车开奖结果历史记录
  ...
  return (
    <NotificationContext.Provider value={{ addNotification, add极速赛车开奖结果历史记录
