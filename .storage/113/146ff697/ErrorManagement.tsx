    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex" dir="rtl">
      ...
      <div className="flex-1 mr-80 p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="bg-gradient-to-br from-green-500
          ...
          <CardContent>
            {loading ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">جاري تحميل الأخطاء...</
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex-1">
                        ...
                        {error.context && (
                          <p className="text-xs text-gray-500">السياق: {
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-sm font-medium text-gray-700">رسالة الخطأ
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-700">الحالة</
