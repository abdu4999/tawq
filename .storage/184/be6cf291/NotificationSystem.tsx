...
const getNotificationStyle = (type: NotificationType) => {
  switch (type) {
    ...
    case 'achievement':
      return {
        className: 'border-purple-200 bg-gradient-to-r from-purple-50 to-p
        className: 'border-purple-200 bg-gradient
    ...
    case 'task':
      return {
        className: 'border-indigo-200 bg-indigo-极速赛车开奖
...
const ERROR_CODES = {
  ...
  SUPABASE_CONNECTION: 'ERR_SUPABASE
