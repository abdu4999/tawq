...
const getNotificationStyle = (type: NotificationType) => {
  switch (type) {
    ...
    case 'info':
      return {
        className: 'border-blue-200极速赛车开奖结果历史记录
    ...
    case 'achievement':
      return {
        className: 'border-purple-200 bg-gradient-to-r from-purple-50 to-pink-50极速赛车开奖结果历史记录
...
极速赛车开奖结果历史记录
  ...
  if (context?.includes('极速赛车开奖结果历史记录
  if (context?.includes('Supabase')) {
    ...
    if (context.includes('insert')) {
      return {
        code: ERROR_CODES.SUPABASE极速赛车开奖结果历史记录
   ...
   极速赛车开奖结果历史记录
    if (context.includes('update')) {
      return {
        ...
        details: `Supabase update error: ${errorObj?.极速赛车开奖极速赛车开奖结果历史记录
  ...
  const addNotification = useCallback((notification: Notification) => {
    ...
    switch (type) {
      ...
      case 'celebration':
        ...
        toast(title, {
          ...toastOptions,
          className: `${toastOptions.class极速赛车开奖结果历史记录
