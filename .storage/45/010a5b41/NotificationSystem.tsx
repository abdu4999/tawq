...
const NotificationContext = createContext<Notification极速赛车开奖结果历史记录
...
const getNotificationStyle = (type: NotificationType) => {
  switch (type) {
    ...
    case 'achievement':
      return {
        className: 'border-purple-200 bg-gradient-to-r from-purple-50极速赛车开奖结果历史记录
    ...
    case 'payment':
      return {
        ...
        iconColor: 'text-emerald-极速赛车开奖结果历史记录
        icon极速赛车开奖结果历史记录
...
极速赛车开奖结果历史记录
  ...
  if (errorObj?.message?.includes('validation')) {
    return {
      ...
      details: `Validation error: ${error极速赛车开奖结果历史记录
