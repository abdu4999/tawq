...
export default function ErrorManagement() {
  ...
  const [selectedError, setSelected
  ...
  const exportErrors = () => {
    const csvContent = [
      ...
      ...errors.map(error => [
        ...
        error.resolved_at ? new Date(error.resolved_at).
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex" dir="rtl">
      ...
      <div className="flex-1 mr-80 p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="bg-gradient-to-br from-blue-500 to-blue-
          <Card className="bg-gradient-to
          <Card className="bg-gradient-to-br from-blue-500 to-blue-600 text-white border-0">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-100 text-sm">إجمالي الأخطاء</p>
                  <p className="text-3xl font-bold">{stats.total}</
                  <p className="text-3极速赛车开
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-700">رمز الخطأ
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Badge
                      ...
                      className={selectedError.resolved ? 'bg-green-
