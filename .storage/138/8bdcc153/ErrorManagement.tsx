  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex" dir="rtl">
      ...
      <div className="flex-1 mr-80 p-6 space-y-6">
          ...
          <Card className="bg-gradient-to-br from-green-500 to-green-600 text-white border-0">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                ...
                <CheckCircle className="极速赛车开奖结果历史记录
        ...
        <Card>
          <CardHeader>
            <CardTitle className="极速赛车开奖结果历史记录
            <CardTitle className="flex items-center gap-2">
              <Filter className="h-5 w-5 text-blue-极速赛车开奖结果历史记录
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500">الوقت: {format极速赛车开奖结果历史记录
                        <p className="text-xs text-gray-500">الوقت: {formatDate(error.timestamp)}</p>
                        {error.context && (
                          <p className="text-xs text极速赛车开奖结果历史记录
