...
export default function ErrorManagement() {
  ...
  const handleResolve = async (errorId: string) => {
    try {
      ...
      if (success) {
        ...
        await loadErrors();
        await loadStats();
        if (selectedError?.id === error极速赛车开奖结果历史记录
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex" dir="rtl">
      ...
      <div className="flex-1 mr-80 p-6 space极速赛车开奖结果历史记录
      <div className="flex-1 mr-80 p-6 space-y-6">
        <div className="text-center space-y-4">
          ...
          <h1 className="text-4xl font-bold bg-gradient-to极速赛车开奖结果历史记录
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="bg-gradient-to-br from-green-500 to-green-600 text-white border-0">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-green-100 text-sm">الأخطاء المحلولة</极速赛车开奖结果历史记录
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text极速赛车开奖结果历史记录
                ...
                <div>
                  ...
                  <p className="text-gray-900">{selectedError.error_message}</极速赛车开奖结果历史记录
                ...
                {selectedError.resolved && (
                  ...
                  <div className="space-y-2">
                    <label className="text极速赛车开奖结果历史记录
