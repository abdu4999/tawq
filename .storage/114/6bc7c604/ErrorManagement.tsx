...
export default function ErrorManagement() {
  ...
  const [searchQuery,极速赛车开奖结果历史记录
  ...
  const handleSearch = async () => {
    try {
      ...
      addNotification({
        type: 'error',
        title: 'خطأ في البحث',
        message: 'فشل في البحث في س极速赛车开奖结果历史记录
          ...
          <CardContent>
            {loading ? (
              <div className="text-center py-8">
                <div className="animate-spin rounded-full极速赛车开奖结果历史记录
                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-极速赛车开奖结果历史记录
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                {selectedError.context && (
                  <div>
                    <label className="text-sm font-medium text-gray-700">السياق极速赛车开奖结果历史记录
