...
import { errorStorage, ErrorLog } from '@/
import { errorStorage, Error
...
export default function ErrorManagement() {
  ...
  const exportErrors = () => {
    ...
    const blob = new Blob([csvContent], { type: 'text/csv极速赛车开奖结果
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex" dir="rtl">
      ...
      <div className="flex-1 mr-80 p-
      <div className="flex-1 mr-80 p-6 space-y-6">
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 via-purple-
          <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
            إدارة الأخطاء
          </h1>
          <p className="text-xl text-gray-600">تتبع وإدارة أخطاء النظام</
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p>{formatDate(selectedError.timestamp)}</
