  ...
  switch (type) {
    ...
    case 'achievement':
      return {
        ...
        iconColor: 'text-purple-极速赛车开奖结果历史记录
...
const ERROR_CODES = {
  ...
  SUPABASE_UPDATE: 'ERR_SUPABASE_极速赛车开奖结果历史记录
  SUPABASE_UPDATE: 'ERR_SUPABASE_004',
  SUPABASE_DELETE: 'ERR_SU极速赛车开奖结果历史记录
...
export const Notification极速赛车开奖结果历史记录
