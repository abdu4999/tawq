...
const navigationItems = [
  ...
  { path: '/my-dashboard', icon: User, label: 'لوحتي', badge: null },
  { path: '/live-performance', icon: Activity, label: 'الأداء الحي', badge: '🔴' },
  ...
  { path: '/donors', icon: Heart, label: 'إدارة المتبرعين', badge: null },
  ...
  { path: '/ai-insights', icon: Brain, label: 'رؤى الذكاء الاصطناعي', badge: '🤖' },
