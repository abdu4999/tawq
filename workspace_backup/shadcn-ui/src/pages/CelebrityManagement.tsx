...
export default function CelebrityManagement() {
  ...
  const handleCreateCelebrity = async () => {
    ...
    try {
      ...
      addNotification({
        type: 'success',
        title: '✅ تم إضافة المشهور',
        message: `تم إضافة "${createdCelebrity.name}" بنجاح`,
        duration: 4000
      });
    } catch (error) {
      ...
      addNotification({
        ...
        message: 'حدث خطأ أثناء إضافة المشهور'
      });
    }
  };
  ...
  const handleUpdateCelebrity = async () => {
    ...
    try {
      ...
      addNotification({
        ...
        message: `تم تحديث بيانات "${updatedCelebrity.name}" بنجاح`
      });
    } catch (error) {
              ...
              <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                ...
                <DialogContent className="max-w-md">
                  ...
                  <DialogFooter>
                    ...
                    <Button onClick={handleCreateCelebrity}>
                      إضافة المشهور
                    </Button>
                  </DialogFooter>
                </DialogContent>
        ...
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          <DialogContent className="max-w-md">
            ...
            <DialogFooter>
              ...
              <Button onClick={handleUpdateCelebrity}>
                حفظ التغييرات
              </Button>
            </DialogFooter>
          </DialogContent>
